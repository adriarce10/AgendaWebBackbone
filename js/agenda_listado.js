...
var ContactoVista = Backbone.View.extend({
    ...
    guardar: function () {
        ...
        this.model.set("alias", this.el.querySelector("#alias_edit").value);
        ...
        this.model.set("direccion", this.el.querySelector("#direccion_edit").value);
...
var ListaContactosVista = Backbone.View.extend({
    ...
    nuevo: function () {
        ...
        nuevo_contacto.set("alias", this.el.querySelector('#alias').value);
